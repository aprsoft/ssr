@php
    use App\Helpers\Customer\MenuHelper;
    ...
    {{-- <div class="pt-8 pb-7 flex"
        ...
        <a href="/">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden"  src="/images/logo/gota-de-agua.png" alt="Logo" width="40" height="40" /> 
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block"  src="/images/logo/gota-de-agua.png" alt="Logo" width="40"
                height="40" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="/images/logo/gota-de-agua.png" alt="Logo" width="32" height="32" />
            SSR {{tenant()->id}}
        </a>
    </div> --}}
    <!-- Logo Section -->
<!-- Logo Section -->
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/" class="flex items-center gap-2.5">
            ...
            <!-- Logo expandido (light) -->
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden"
                src="/images/logo/gota-de-agua.png" alt="Logo" width="40" height="40" />
            ...
            <!-- Tenant ID solo cuando está expandido -->
            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="text-sm font-semibold tracking-wide text-gray-700 dark:text-gray-200 truncate">
                <span>SSR · {{ ucwords(preg_replace('/([A-Z])/', ' $1', tenant()->id)) }} </span>
