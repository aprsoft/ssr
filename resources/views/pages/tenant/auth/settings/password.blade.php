...
@section('content')
    ...
    <x-layouts.settings title="Contraseña" description="Actualiza tu contraseña para mantener tu cuenta segura">
        ...
        <form method="POST" action="{{ route('tenant.settings.password.update') }}" class="space-y-6">
            @csrf
            @method('PUT')
