@extends('layouts.tenant.fullscreen-layout')
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        <div class="mb-5 sm:mb-8">
                            <h1 class="flex items-center gap-2 text-title-sm sm:text-title-md mb-2 font-semibold text-gray-800 dark:text-white/90">
                                <img src="{{ global_asset('images/logo/gota-de-agua.png') }}" alt="Logo" class="h-12 w-12 object-contain" />
                                <span>SSR · {{ $tenantName }}</span>
                            </h1>
                        ...
                        <div>
                            <form method="POST" action="{{ route('tenant.login') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="usuario@aprsoft.cl" autofocus
                          ...
                          {{--   <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    ...
                                    <a href="{{ route('tenant.register') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Sign Up</a>
                                </p>
                            </div> --}}
                        </div>
                    </div>
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="{{ route('tenant.dashboard') }}" class="mb-4 block">
                        <img src="{{ global_asset('images/logo/gota-de-agua.png') }}" alt="Logo" width="90" height="90" />                        </a>
