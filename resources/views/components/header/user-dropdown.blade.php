 @php
    use App\Helpers\Function\FunctionHelper;

    $routePrefix = FunctionHelper::routePrefix(); 
...
<div class="relative" x-data="{
    ...
    <button
        ...
        type="button"
    >
        <span class="flex items-center justify-center text-center mr-3 overflow-hidden rounded-full h-11 w-11 bg-gray-200 text-black dark:bg-gray-700 dark:text-white">
            {{ Auth::user()->initials() }}
        </span>
        ...
        <ul class="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
            @php
                $menuItems = [
                    [
                        'text' => 'Editar Perfil',
                        'path' => route("{$routePrefix}.settings.profile.edit"),
