...
class ChileAdministrativeDivisionsSeeder extends Seeder
{
    public function run()
    {
        ...
        */
        ...
        // $cities = array_map(function ($citie) use ($now) {
        //     return [                
        //         'name' => $citie[0],
        //         'province_id' => $citie[1],
        //         'updated_at' => $now,
        ...
        // $cityMap = collect($cities)->pluck('id', 'name');
        ...
        */
        ...
        // $communes = array_map(function ($commune) use ($now,$cityMap) {
        $communes = array_map(function ($commune) use ($now) {

            // $cityId = $cityMap->get($commune[2], null);
        ...
        */
        ...
        $localities = array_map(function ($loc) use ($now) {
            return [
                'id' => $loc[0],
                'name' => $loc[1],
                'commune_id' => $loc[2],
        ...
        */
        $sectors = [
            ...
            [14, 1,'V. Mar'],
            [15, 1,'Encierra'],
            [16, 1,'Villa Esperanza'],
            [17, 1,'La Mestiza'],
            [18, 1,'Los Mayos'],
            [19, 1,'Lomas de Catapilco'],
            [20, 1,'Por Definir'],
        ];

        $sectors = array_map(function ($sec) use ($now) {
            return [
                'id' => $sec[0],
                'locality_id' => $sec[1],
                'name' => $sec[2],                
